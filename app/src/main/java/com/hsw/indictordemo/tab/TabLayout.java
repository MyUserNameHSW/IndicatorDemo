package com.hsw.indictordemo.tab;
...
//                mPath.moveTo(indicatorLeft + smDim, startY);
//                mPath.quadTo(smDim + indicatorLeft + total / 2, endY, indicatorRight - smDim, startY);
                canvas.drawPath(mPath, paint);
